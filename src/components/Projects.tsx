...
import pg01 from "../PulseGaurd01.png";
import pg02 from "../PulseGuard02.png";
import pg03 from "../PulseGaurd03.png";
import tl01 from "../ThreatLense01.png";
import tl02 from "../Threatlense02.png";
import tl03 from "../ThreatLense03.png";
import cers01 from "../CERS01.png";
import cers02 from "../CERS02.png";
import cers03 from "../CERS03.png";
import ss01 from "../StudentSync01.png";
...
interface ProjectData {
  ...
  images: string[]; githubUrl?: string; liveUrl?: string;
          ...
          <div className="clones-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {UIClones.map(clone => (
              ...
              <div className="relative aspect-[16/10] overflow-hidden bg-[#080808]">
                ...
                <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-3 px-4 text-center z-20">
